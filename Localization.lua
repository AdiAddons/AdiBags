...
L["By name"] = "按物品名稱" -- Needs review
L["By quality and item level"] = "按品質和物品等級"
L["Category"] = "種類"
L["Check this to display a bag type tag in the top left corner of items."] = "在物品左上角顯示背包標籤"
L["Check this to display a colored border around items, based on item quality."] = "依物品品質著色邊框" -- Needs review
L["Check this to display an icon after usage of each type of bags."] = "在每個背包運用類型後顯示圖示。" -- Needs review
L["Check this to display an indicator on quest items."] = "在任務物品上顯示指示。" -- Needs review
L["Check this to display an textual tag before usage of each type of bags."] = "在每個背包運用類型前顯示文字標記。" -- Needs review
L["Check this to have poor quality items dimmed."] = "黯淡品質為粗糙的物品"
L["Check this to show space at your bank in the plugin."] = "在銀行中顯示背包空間。" -- Needs review
L["Check this to show this section. Uncheck to hide it."] = "設定要顯示的區段"
L["Check to enable this module."] = "點選以啟用模組。" -- Needs review
L["Click on this button to create the new association."] = "建立新的關聯"
L["Click there to reset the bag positions and sizes."] = "點擊重置背包位置和尺寸。" -- Needs review
...
L["One section per item slot."] = "依物品各自分區" -- Needs review
L["One section per set"] = "依套裝分組" -- Needs review
