...
L["... but not when trading"] = "... но не во время торговли"
...
L["Do not merge incomplete stack at merchants', auction house, bank, mailboxes or when trading."] = "Не складывать не полные стопки в окне продажи, аукциона, банка, почтового ящика или во время торговли."
...
L["Stackable items"] = "Предметы, которые могут быть сложены в стопки."
...
L["Unstackable items"] = "Вещи, которые не могут быть сложены"
...
L["Unstackable items"] = "Objetos no apilables"
