...
L["Automatically rearrange sections ..."] = "Réarranger les sections automatiquement..." -- Needs review
...
L["Only when required"] = "Seulement si nécessaire" -- Needs review
L["Opacity"] = "Opacité"
...
L["When not talking to merchant, banker, ..."] = "Lorsque je ne cause pas à un marchand, un banquier, ..." -- Needs review
