...
L["Configure"] = true
L["Dim junk"] = true
L["Do not merge incomplete stack at merchants', auction house, bank, mailboxes or when trading."] = true
L["Enabled"] = true
...
if locale == 'frFR' then
L["... but not when trading"] = ".. mais pas pendant un échange"
...
L["Do not merge incomplete stack at merchants', auction house, bank, mailboxes or when trading."] = "Ne fusionne pas les piles incomplètes chez les marchands, à l'autel des vents, la banque, la boîte au lettre ou lors d'échanges."
...
L["Unstackable items"] = "Objets non-empilables"
...
L["Bag #%d"] = "Bolsa #%d" -- Needs review
L["Bank bag #%d"] = "Bolsa de banco #%d" -- Needs review
L["Check this to display an indicator on quest items."] = "Marca esto para mostrar un indicador en los objetos de quest" -- Needs review
L["Check this to display one individual section per set. If this is disabled, there will be one big \"Sets\" section."] = "Marca esto para mostrar una sección por cada set. Si está desactivado, habra una gran sección de \"Sets\"" -- Needs review
L["Click to reset item status."] = "Click para resetear el estado de los items" -- Needs review
L["Merge incomplete stacks with complete ones."] = "Unir pilas de objetos para completar una" -- Needs review
L["Merge stackable items"] = "Unir objetos apilables" -- Needs review
L["Right-click to try to empty this bag."] = "Boton derecho para intentar vaciar esta bolsa" -- Needs review
L["Section visibility button"] = "Seccion de visibilidad del boton" -- Needs review
L["Show only one free slot for each kind of bags."] = "Mostrar solo 1 hueco libre para cada bolsa" -- Needs review
L["Show only one slot of items that can be stacked."] = "Mostrar solo 1 hueco de objetos que pueden apilarse" -- Needs review
L["Show only one slot of items that cannot be stacked."] = "Mostrar solo 1 hueco de objetos que no pueden apilarse" -- Needs review
L["Unstackable items"] = "Objetos no apilables" -- Needs review

------------------------ zhTW ------------------------
elseif locale == 'zhTW' then
L["... but not when trading"] = "... 但不是交易時"
...
L["Adjust the maximum height of the bags, relative to screen size."] = "調整背包最大高度"
L["Adjust the maximum number of items per row."] = "設定每行最多物品數目"
L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] = "允許手動裝備放置區段，請將裝備拖曳至區段視窗。"
L["Always"] = "一直"
L["Ammunition"] = "彈藥"
L["Anchored"] = "錨點過"
...
L["Category"] = "種類"
L["Check this to display a bag type tag in the top left corner of items."] = "勾選可在物品左上角顯示背包標籤"
...
L["Check this to have poor quality items dimmed."] = "將不良品質裝備顯示變淡"
...
L["Click on this button to create the new association."] = "點擊以建立新的相關"
...
L["Close"] = "關閉"
L["Configure"] = "配置"
L["Consider gems as a subcategory of trade goods"] = "將寶石設定為交易物品"
L["Consider glyphs as a subcategory of trade goods"] = "將雕紋設定為交易物品"
L["Consumable"] = "消耗品"
...
L["Do not merge incomplete stack at merchants', auction house, bank, mailboxes or when trading."] = "於商人、拍賣所、銀行、郵箱或交易時不要合併不完全堆疊。"
...
L["One section per item slot."] = "一節每物品糟。"
L["One section per set"] = "一節每設定"
...
L["... including incomplete stacks"] = "겹침 아이템 모두 포함"
...
L["Check this to show this section. Uncheck to hide it."] = "체크하면 현재 섹션이 표시됩니다. 체크해제하면 다시 숨깁니다."
...
L["Merge incomplete stacks with complete ones."] = "아이템 겹침이 최대가 아니라도 포함하여 표시합니다."
L["Merge stackable items"] = "겹침 아이템 합치기"
L["Merged sets"] = "세트 병합"
L["Miscellaneous"] = "기타"
L["Money"] = "소지금"
L["Never"] = "안함"
...
L["Right-click to try to empty this bag."] = "오른쪽 클릭으로 가방을 비우려고 합니다."
L["SOUL_BAG_TAG"] = "조각"
L["Scale"] = "비율"
L["Search:"] = "검색:"
L["Section"] = "항목"
...
L["Show only one free slot for each kind of bags."] = "각각의 가방의 빈 공간을 하나로 표시합니다."
L["Show only one slot of items that can be stacked."] = "겹칠 수 있다면 하나로 표시합니다."
L["Show only one slot of items that cannot be stacked."] = "겹칠 수 없는 아이템도 하나로 표시합니다."
L["Slot number"] = "칸수"
...
L["Unstackable items"] = "겹칠 수 없는 아이템"
