...
L["Check this to display a colored border around items, based on item quality."] = "Anhaken um den Rahmen des Gegenstandes in der Farbe seiner Qualität anzuzeigen"
L["Check this to display an indicator on quest items."] = "Anhaken um Questgegenstände mit einem farblichen Rahemn hervorzuheben."
...
L["Configure"] = "Konfigurieren" -- Needs review
...
L["Junk"] = "Müll" -- Needs review
L["Miscellaneous"] = "Verschiedenes" -- Needs review
L["Money"] = "Geld" -- Needs review
