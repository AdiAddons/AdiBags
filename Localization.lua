...
L["Add a dropdown menu to bags that allow to hide the sections."] = "adicione um menu retrátil nas bolsas que permitem esconder as seções" -- Needs review
L["Add association"] = "Adicionar associação" -- Needs review
L["Add more information in tooltips related to items in your bags."] = "Adicionar mais informação nas janelas de saque relacionadas aos itens em suas bolsas" -- Needs review
L["AdiBags Anchor"] = "âncora do AdiBags" -- Needs review
L["Adjust the maximum height of the bags, relative to screen size."] = "Ajusta a altura máxima das bolsas, relativo a altura da tela" -- Needs review
L["Adjust the maximum number of items per row."] = "ajusta o número máximo de itens por linha" -- Needs review
L["AH category"] = "Categoria da casa de leilões" -- Needs review
L["AH subcategory"] = "Subcategoria da casa de leilões" -- Needs review
L["Allow you manually redefine the section in which an item should be put. Simply drag an item on the section title."] = "Lhe permite manualmente redefinir a seção na qual um item deve ser colocado. Simplesmente arraste o item no título de seleção."
L["Always"] = "sempre" -- Needs review
L["Ammunition"] = "Munição"
L["Anchored"] = "Ancorado" -- Needs review
L["Are you sure you want to remove this section ?"] = "Tem certeza de que deseja remover esta seção?" -- Needs review
L["Background colors"] = "cor de fundo" -- Needs review
L["Backpack"] = "mochila" -- Needs review
L["Bag number"] = "número da bolsa" -- Needs review
L["Bags"] = "bolsas"
L["Bag type"] = "tipo de bolsa" -- Needs review
...
L["Change stacking at merchants', auction house, bank, mailboxes or when trading."] = "Mude empilhando nos vendedores, casa de leilões, banco, caixa de correio ou quando negociando" -- Needs review
L["Check sets that should be merged into a unique \"Sets\" section. This is obviously a per-character setting."] = "verifica equipamentos que deveriam ser fundidos numa única seção \"sets\". Isso é obviamente uma configuração por personagem" -- Needs review
L["Check this so armors are dispatched in four sections by type."] = "Marque isso para que armaduras sejam colocadas em quatro seções por tipo" -- Needs review
L["Check this so tidying is performed when you close the loot windows or you leave merchants, mailboxes, etc."] = "marque isso para que arrumação seja feita quando você fecha a janela de saque, vendedores, caixas dos correios, etc" -- Needs review
L["Check this to display a bag type tag in the top left corner of items."] = "marque isso para mostrar o tipo de bolsa no topo esquerdo dos itens" -- Needs review
L["Check this to display a colored border around items, based on item quality."] = "Marque isso para mostrar uma borda colorida em volta dos itens, baseados em sua qualidade"
L["Check this to display an icon after usage of each type of bags."] = "Marque isso para mostrar um ícone após o uso de cada tipo de bolsas"
L["Check this to display an indicator on quest items."] = "marque isso para mostrar um indicador de itens de missões"
L["Check this to display an textual tag before usage of each type of bags."] = "Marque isso para mostrar uma aba de texto antes do uso de cada tipo de bolsas"
L["Check this to display one individual section per set. If this is disabled, there will be one big \"Sets\" section."] = "marque isso para mostrar uma seção individual por conjunto de equipamentos" -- Needs review
L["Check this to display only one value counting all equipped bags, ignoring their type."] = "marque isso para mostrar somente um valor contando todas as bolsas equipadas, ignorando seu tipo" -- Needs review
L["Check this to have poor quality items dimmed."] = "Marque isso para ter itens de qualidade inferior apagados" -- Needs review
L["Check this to show space at your bank in the plugin."] = "marque isso para mostrar o espaço no seu banco no plugin" -- Needs review
L["Check this to show this section. Uncheck to hide it."] = "Marque isso para mostrar essa seção. Desmarque para escondê-la" -- Needs review
L["Check to enable this module."] = "marque isso para habilitar esse módulo" -- Needs review
L["Click on a item to remove it from the list. You can drop an item on the empty slot to add it to the list."] = "Clique em um item para removê-lo da lista. Você pode soltar um item num espaço vazio para adicioná-lo a lista" -- Needs review
L["Click on this button to create the new association."] = "clique neste botão para criar uma nova associação" -- Needs review
L["Click or drag this item to remove it."] = "clique e arraste este item para removê-lo" -- Needs review
L["Click there to reset the bag positions and sizes."] = "clique ali para resetar os tamanhos e posições das bolsas" -- Needs review
L["Click to purchase"] = "clique para comprar" -- Needs review
L["Click to reset item status."] = "clique para resetar os status dos itens" -- Needs review
L["Click to select which sections should be shown or hidden. Section visibility is common to all bags."] = "Clique para selecionar quais seções deverão ser mostradas ou escondidas. Seleção de visibilidade é comum para todas as bolsas." -- Needs review
L["Click to tidy bags."] = "clique para arrumar as bolsas" -- Needs review
L["Click to toggle the bag anchor."] = "clique para alternar a âncora da bolsa" -- Needs review
L["Click to toggle the equipped bag panel, so you can change them."] = "clique para alternar o painel de equipados, para que você possa mudá-los" -- Needs review
L["Close"] = "Feche" -- Needs review
L["Configure"] = "Configure" -- Needs review
L["Consider gems as a subcategory of trade goods"] = "Considera gemas como uma subcategoria de bens de troca" -- Needs review
L["Consider glyphs as a subcategory of trade goods"] = "Considera glifos como uma subcategoria de bens de troca" -- Needs review
L["Container information"] = "informação do conteiner" -- Needs review
L["Currencies to show"] = "Moedas a mostrar" -- Needs review
L["Currency"] = "moeda" -- Needs review
L["Dim junk"] = "Apagar sucata" -- Needs review
L["Display character currency at bottom left of the backpack."] = "Mostrar moedas do personagem na parte inferior esquerda da mochila" -- Needs review
L["Display character money at bottom right of the backpack."] = "Mostra o dinheiro do personagem na parte de baixo direita da mochila" -- Needs review
L["Drop an item there to add it to the list."] = "Solte um item aqui para adicioná-lo a lista" -- Needs review
L["Drop your item there to add it to this section."] = "Solte seu item aqui para adicionar a esta seção" -- Needs review
L["Enabled"] = "Ligado" -- Needs review
L["Enter a text to search in item names."] = "entre com um texto para pesquisar os nomes dos itens" -- Needs review
L["Enter the name, link or itemid of the item to associate with the section. You can also drop an item into this box."] = "entre com o nome, link ou ID do item para associá-lo com a seção. Você também pode soltar o item nesta caixa" -- Needs review
L["Enter the name of the section to associate with the item."] = "entre o nome da seção para associar com o item" -- Needs review
L["Equipment"] = "equipamento" -- Needs review
L["Equipped bags"] = "bolsas equipadas" -- Needs review
L["Exclude list"] = "Excluir a lista" -- Needs review
L["Fill lines at most"] = "Encher linhas até o máximo" -- Needs review
L["Filter"] = "filtro" -- Needs review
L["Filtering information"] = "informação de filtragem" -- Needs review
L["Filters"] = "filtros" -- Needs review
L["Filters are used to dispatch items in bag sections. One item can only appear in one section. If the same item is selected by several filters, the one with the highest priority wins."] = "filtros são usados para enviar itens para as seções das bolsas. Um item pode aparecer somente em uma seção. Se o mesmo item está selecionado para vários filtros, o com maior prioridade definida vence." -- Needs review
L["Four general sections."] = "Quatro seções gerais" -- Needs review
L["Free space"] = "espaço livre" -- Needs review
L["Free space / total space"] = "Espaço livre / espaço total" -- Needs review
L["Gear manager item sets"] = "Gerenciador de equipamento" -- Needs review
L["Gems are trade goods"] = "Gemas são bens de troca" -- Needs review
L["Glyphs are trade goods"] = "Glifos são bens de troca" -- Needs review
L["Group sections of same category"] = "Agrupar seções de mesma categoria" -- Needs review
L["Highlight color"] = "cor de destaque" -- Needs review
L["Highlight scale"] = "escala de destaque" -- Needs review
L["Ignore low quality items"] = "Ignora itens de qualidade inferior" -- Needs review
L["Included categories"] = "Categorias inclusas" -- Needs review
L["Include list"] = "Incluir lista" -- Needs review
L["... including incomplete stacks"] = "... incluindo pilhas incompletas" -- Needs review
L["Item"] = "Item" -- Needs review
L["Item category"] = "categoria do item" -- Needs review
L["Item information"] = "Informação do item" -- Needs review
L["Items"] = "itens" -- Needs review
L["Item search"] = "pesquisa de item" -- Needs review
L["Items in this list are always considered as junk. Click an item to remove it from the list."] = "Itens nessa lista são sempre considerados sucata. Click em um item para removê-lo da lista" -- Needs review
L["Items in this list are never considered as junk. Click an item to remove it from the list."] = "Itens nessa lista nunca serão considerados sucata. Clique em um item para removê-lo da lista." -- Needs review
...
L["Manual filtering"] = "filtragem manual" -- Needs review
L["Maximum bag height"] = "Altura máxima da bolsa" -- Needs review
L["Maximum row width"] = "largura máxima da coluna" -- Needs review
L["Maximum stack size"] = "Tamanho máximo do empilhamento" -- Needs review
L["Merge bag types"] = "fundir tipos de bolsas" -- Needs review
L["Merged sets"] = "Sets fundidos" -- Needs review
L["Merge free space"] = "Fundir espaço livre" -- Needs review
L["Merge incomplete stacks with complete ones."] = "Funde pilhas incompletas com completas" -- Needs review
L["Merge stackable items"] = "Funde itens empilháveis" -- Needs review
L["Merge unstackable items"] = "Fundir itens não empilháveis" -- Needs review
L["Money"] = "dinheiro" -- Needs review
L["Never"] = "nunca" -- Needs review
L["New"] = "novo" -- Needs review
L["New item highlight"] = "destaque de itens novos" -- Needs review
L["New Override"] = "Novo override" -- Needs review
L["One section per item slot."] = "Uma seção por espaço" -- Needs review
L["One section per set"] = "uma seção por set" -- Needs review
...
L["Provides a text widget at top of the backpack where you can type (part of) an item name to locate it in your bags."] = "Fornece um widget de texto no topo da mochila onde você pode escrever (parte de) um nome de um item para localizá-lo em suas bolsas" -- Needs review
L["Put any item that can be equipped (including bags) into the \"Equipment\" section."] = "põe qualquer item que pode ser equipado (incluindo bolsas) na categoria \"equipamento\"" -- Needs review
L["Put items belonging to one or more sets of the built-in gear manager in specific sections."] = "Põe itens pertencentes a um ou mais sets do gerenciador de equipamentos padrão em seções específicas" -- Needs review
L["Put items in sections depending on their first-level category at the Auction House."] = "Põe itens em seções dependendo da categoria inicial na Casa de Leilões" -- Needs review
L["Put items of poor quality or labeled as junk in the \"Junk\" section."] = "Põe itens de qualidade inferior ou rotulados como sucata na seção \"Sucata\" " -- Needs review
L["Put quest-related items in their own section."] = "Põe itens relativos a missões em suas respectivas seções" -- Needs review
L["Quality highlight"] = "Destaca qualidade" -- Needs review
L["Quest indicator"] = "indicador de missões" -- Needs review
L["Quest Items"] = "itens de missões" -- Needs review
L["Remove"] = "Remover" -- Needs review
L["Reset new items"] = "reseta itens novos" -- Needs review
L["Reset position"] = "reseta posição" -- Needs review
L["Right-click to try to empty this bag."] = "Clique com o botão direito para esvaziar esta bolsa" -- Needs review
L["Scale"] = "escala" -- Needs review
L["Section"] = "Seção" -- Needs review
L["Section category"] = "Categoria da seção" -- Needs review
L["Section setup"] = "Configurações de seção" -- Needs review
L["Section visibility"] = "Visibilidade da seção" -- Needs review
L["Section visibility button"] = "Seção do botão de vsibilidade" -- Needs review
L["Select how bag usage should be formatted in the plugin."] = "Seleciona como o uso de bolsas de ser formatado no plugin" -- Needs review
L["Select how items should be sorted within each section."] = "Seleciona quantos itens devem ser arrumados em cada seção" -- Needs review
L["Select how the bag are positionned."] = "Selecione como a bolsa é posicionada" -- Needs review
L["Select the category of the section to associate. This is used to group sections together."] = "Selecione a seção para associar. Isso é usado para agrupar seções juntas" -- Needs review
L["Select the sections in which the items should be dispatched."] = "Selecione as seções para as quais os itens serão encaminhados" -- Needs review
L["Select which first-level categories should be split by sub-categories."] = "Seleciona qual categoria primária deve ser dividida em subcategorias" -- Needs review
L["Semi-automated tidy"] = "Arrumação semi-automatizada" -- Needs review
L["Separate incomplete stacks."] = "Separar pilhas incompletas" -- Needs review
L["Separate unstackable items."] = "Separar itens não empilháveis" -- Needs review
L["Sets"] = "Sets" -- Needs review
L["Show bag type icons"] = "Mostrar o ícone dos tipos de bolsas" -- Needs review
L["Show bag type tags"] = "Mostrar a aba dos tipos de bolsas" -- Needs review
L["Show bank usage"] = "Mostrar ocupação do banco" -- Needs review
L["Show container information..."] = "Mostrar informação da janela de saque" -- Needs review
L["Show every distinct item stacks."] = "mostrar cada pilha diferente de itens" -- Needs review
L["Show filtering information..."] = "Mostrar informação de filtragem" -- Needs review
L["Show item information..."] = "Mostrar informação do item" -- Needs review
L["Show only one free slot for each kind of bags."] = "Mostre somente um espaço livre para cada tipo de bolsa" -- Needs review
L["Show only one slot of items that can be stacked."] = "Mostre somente um espaço com itens que podem ser empilhados" -- Needs review
L["Show only one slot of items that cannot be stacked."] = "mostre somente um espaço de itens que não podem ser empilhados" -- Needs review
L["Show %s"] = "Mostra" -- Needs review
L["Slot number"] = "Número do slot" -- Needs review
L["Sorting order"] = "Ordem de arrumação" -- Needs review
L["Space in use"] = "espaço em uso" -- Needs review
L["Space in use / total space"] = "espaço em uso / espaço total" -- Needs review
L["Split armors by types"] = "Separar armaduras por tipo" -- Needs review
L["Split by subcategories"] = "Divide em subcategorias" -- Needs review
L["Strictly keep ordering"] = "manter estritamente ordenado" -- Needs review
L["Tidy bags"] = "Arruma bolsas" -- Needs review
L["Tidy your bags by clicking on the small \"T\" button at the top left of bags. Special bags with free slots will be filled with macthing items and stackable items will be stacked to save space."] = "Arrume suas bolsas clicando no pequeno botão \"T\" no topo esquerdo de suas bolsas. Bolsas especiais com espaços livres serão preenchidas com respectivos itens e itens empilháveis serão empilhados para liberar espaço" -- Needs review
L["Toggle and configure item filters."] = "Alterna e configura filtros de itens" -- Needs review
L["Toggle and configure plugins."] = "Alterna e configura plugins" -- Needs review
L["Tooltip information"] = "Informação da janela de saque" -- Needs review
L["Track new items"] = "rastreia itens novos" -- Needs review
L["Track new items in each bag, displaying a glowing aura over them and putting them in a special section. \"New\" status can be reset by clicking on the small \"N\" button at top left of bags."] = "rastreia itens novos em cada bolsa, mostrando uma aura brilhante sobre eles e colocando-os em uma seção especial. Status \"Novo\" pode ser apagado clicando no pequeno botão \"N\" no topo esquerdo de suas bolsas" -- Needs review
L["Uncheck this to disable AdiBags."] = "Desmarque isso para desabilitar AdiBags" -- Needs review
L["Unlock anchor"] = "Destrava âncora" -- Needs review
L["Use this section to define any item-section association."] = "Use esta seção para definir qualquer associação seção-item" -- Needs review
L["Use this to adjust the bag scale."] = "Use isso para ajustar a escala da bolsa" -- Needs review
L["Use this to adjust the quality-based border opacity. 100% means fully opaque."] = "Use isto para ajustar a opacidade da borda baseada na qualidade. 100% significa totalmente opaco" -- Needs review
L["Virtual stacks"] = "Emplilhamento virtual" -- Needs review
L["Virtual stacks display in one place items that actually spread over several bag slots."] = "Emplilhamentos virtuais mostram em um espaço itens que na verdade se espalhariam por vários espaços das bolsas" -- Needs review
L["Virtual stack slots"] = "Espaços de pilhas virtuais" -- Needs review
L["When alt is held down"] = "quando alt é segurado" -- Needs review
L["When any modifier key is held down"] = "quando qualquer tecla modificadora é segurada" -- Needs review
L["When ctrl is held down"] = "quando ctrl é segurado" -- Needs review
L["When shift is held down"] = "quando shift é segurado" -- Needs review
L["When trading:"] = "Quando negociando:" -- Needs review
end
