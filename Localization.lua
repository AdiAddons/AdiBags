...
L["AMMO_TAG"] = "Ba"
L["Add a dropdown menu to bags that allow to hide the sections."] = "Ajoute un menu déroulant aux sacs pour cacher les sections." -- Needs review
...
L["Adjust the maximum number of items per row."] = "Ajustez le nombre maximal d'objets par ligne." -- Needs review
...
L["Anchored"] = "Ancrée"
L["Are you sure you want to remove this section ?"] = "Etes-vous sûr de vouloir effacer cette section ?" -- Needs review
...
L["Check sets that should be merged into a unique \"Sets\" section. This is obviously a per-character setting."] = "Cochez les ensembles qui doivent être fusionnés en une section \"Ensembles\" unique. C'est évidemment un réglage spécifique à ce personnage." -- Needs review
...
L["Check this to display one individual section per set. If this is disabled, there will be one big \"Sets\" section."] = "Cochez ceci pour afficher une section individuelle par ensemble d'équipement. Sinon, il n'y aura qu'une seule section \"Ensembles\"." -- Needs review
...
L["Check this to have poor quality items dimmed."] = "Cochez ceci pour assombrir les objets de mauvaise qualité." -- Needs review
...
L["Click on a item to remove it from the list. You can drop an item on the empty slot to add it to the list."] = "Cliquer sur un objet pour le retirer de la liste. Vous pouvez mettre un objet dans l'emplacement vide pour l'ajouter à la liste." -- Needs review
L["Click on this button to create the new association."] = "Cliquez sur ce bouton pour créer la nouvelle association."
L["Click or drag this item to remove it."] = "Cliquez sur l'objet ou glissez le pour le retirer." -- Needs review
...
L["Drop an item there to add it to the list."] = "Glissez un objet ici pour l'ajouter à la liste." -- Needs review
...
L["Exclude list"] = "Liste \"exclus\"" -- Needs review
...
L["Include list"] = "Liste \"inclus\"" -- Needs review
L["Included categories"] = "Catégories incluses" -- Needs review
L["Item"] = "Objet"
L["Item category"] = "Catégories d'objets"
L["Item information"] = "Informations sur l'objet"
L["Item search"] = "Recherche d'objet"
L["Items"] = "Objets"
L["Items in this list are always considered as junk. Click an item to remove it from the list."] = "Les objets de cette liste sont considérés comme Camelote. Cliquez sur un objet pour le retirer de la liste." -- Needs review
L["Items in this list are never considered as junk. Click an item to remove it from the list."] = "Les objets de cette liste ne sont jamais considérés comme Camelote. Cliquez sur un objet pour le retirer de la liste." -- Needs review
L["Jewelry"] = "Joaillerie"
L["Junk category"] = "Catégorie camelote" -- Needs review
L["KEYRING_TAG"] = "Cl"
...
L["Low quality items"] = "Objets de qualité médiocre." -- Needs review
L["MINING_BAG_TAG"] = "Mi"
L["Manual"] = "Manuelle"
...
L["Section visibility button"] = "Bouton de visibilité des sections." -- Needs review
...
L["Select which first-level categories should be split by sub-categories."] = "Sélectionnez quelles catégories doivent être séparées en sous-catégories." -- Needs review
...
L["Show filtering information..."] = "Afficher les informations de filtrage..." -- Needs review
...
L["Unlock anchor"] = "Déverrouiller l'ancre" -- Needs review
