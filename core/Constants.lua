...
-- Expansion names
addon.EXPANSION_MAP = {
	[LE_EXPANSION_CLASSIC] = EXPANSION_NAME0,
	[LE_EXPANSION_BURNING_CRUSADE] = EXPANSION_NAME1,
	[LE_EXPANSION_WRATH_OF_THE_LICH_KING] = EXPANSION_NAME2,
	[LE_EXPANSION_CATACLYSM] = EXPANSION_NAME3,
	[LE_EXPANSION_MISTS_OF_PANDARIA] = EXPANSION_NAME4,
	[LE_EXPANSION_WARLORDS_OF_DRAENOR] = EXPANSION_NAME5,
	[LE_EXPANSION_LEGION] = EXPANSION_NAME6,
	[LE_EXPANSION_BATTLE_FOR_AZEROTH] = EXPANSION_NAME7,
	[LE_EXPANSION_SHADOWLANDS] = EXPANSION_NAME8,
	[LE_EXPANSION_DRAGONFLIGHT] = EXPANSION_NAME9,
}
